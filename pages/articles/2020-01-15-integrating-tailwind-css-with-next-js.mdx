...
I've already covered about [TailwindCSS](https://tailwindcss.com/) in one of my [previous posts](https://www.li-ke.netlify.com/what-is-tailwind-css). In short, TailwindCSS is a utility-first CSS framework which aims to provide us with a set of utlity classes (like flex, block, inline-block, etc.). In addition to that, it also provides us utility classes to create CSS grids, responsive designs as well as style hover, focus and active pseudo-classes.
...
I've written about how to integrate TailwindCSS with React in one of my [previous posts](https://www.li-ke.netlify.com/what-is-tailwind-css). The process of integrating TailwindCSS with Next.js will be a similar one.
...
If you want to know more about configuring Tailwind, you can read it [here](https://www.li-ke.netlify.com/what-is-tailwind-css).
