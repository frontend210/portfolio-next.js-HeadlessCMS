...
## Introduction
We'd developed a Pagination component in one of our [previous posts](https://li-ke.netlify.com/articles/how-to-create-an-accessible-pagination-component-with-react). We'll be taking inspiration from that component and convert it into a NPM package.
